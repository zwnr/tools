# Make lists
#network_color = [ 'Blue', 'Green', 'Orange', 'Red' ]
#device = [ 'Accedian', 'Adva', 'Adtran', 'Ciena', 'Cisco', 'RAD' ]
#stage = [ '1', '2' ]
...
if selection == 1:
 ...
 # Choose NID Stage     
 if nid_vendor == 1:
   print(accedian_stage1.cfg)
 elif nid_vendor == 2:
   print(adva_ge114pro_stage1.cfg)
 elif nid_vendor == 3:
   print(ciena5142_stage1.cfg)
 elif nid_vendor == 4:
   print(cisco_nid_stage1.cfg)
 elif nid_vendor == 5:
   print(rad_203_stage1.cfg)
